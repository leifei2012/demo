...
public class SellerOrder {
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<OrderDTO> orderDTOPage = OrderMsterser.findAll(request);
...
//        orderDTOPage.getTotalPages()
    ...
    public ModelAndView detail(@RequestParam("orderId") String orderId,
        ...
        try {
            orderDTO = OrderMsterser.findOne(Integer.valueOf(orderId));
        }catch (SellException e) {
    ...
    public ModelAndView finished(@RequestParam("orderId") Integer orderId,
                                 Map<String, Object> map) {
        try {
            OrderDTO orderDTO = OrderMsterser.findOne(orderId);
            OrderMsterser.finish(orderDTO);
        } catch (SellException e) {
